...
public class FlightControllerEditor : Editor 
{
	public override void OnInspectorGUI()
	{
		...
		flightCC.missile = (GameObject)EditorGUILayout.ObjectField(new GUIContent("Projectile Game Object", "Projectile that will be fired from the weapon hardpoint."), flightCC.missile, typeof(GameObject), true);
